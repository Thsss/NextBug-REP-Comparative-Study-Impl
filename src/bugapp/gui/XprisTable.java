...
public class XprisTable extends javax.swing.JTable{
    ...
    /**
     * Inicializa as variav�is sistem�ticas do XprisTable
     * N�O UTILIZAR. Esse m�todo � chamado automaticamente.
     */
    ...
    /**
     * Seta os T�tulos de TODAS as colunas do XprisTable
     *
     * @param newTitle Vetor contendo os t�tulos das colunas
     */
    ...
    /**
     * Seta o t�tulo de uma coluna do XprisTable
     *
     * @param ColIndex �ndice da coluna baseado nos dados completos.
     * @param newTitle O novo t�tulo da coluna
     */
    ...
    /**
     * M�todo protegido que pega cada <code>TableColumn</code> e altera seu preferred width.
     */
    ...
    /**
     * Indica se a coluna poder� ser editada pelo usu�rio. Valor default false.
     * @param ColIndex �ndice da coluna baseado nos dados completos.
     * @param aFlag True se o usu�rio puder editar a coluna, False caso o contr�rio.
     */
    ...
    /**
     * Seta se o usu�rio poder� editar cada uma das colunas do XprisTable.
     */
    ...
    /**
     * Retorna o objeto na posi��o especificada, mesmo que esteja invisivel.
     *
     * ATEN��O: Se estiver usando o m�todo pra exibir colunas utilizar o metodo
     * get(int row, String colName) para ter certeza que o dado retornado ser� o correto.
     *
     * @return O objeto na posi��o indicada
     */
    ...
    public void setData(java.sql.ResultSet Rs) throws java.sql.SQLException{
        ...
        while(Rs.next()){
            ...
            for(int i=0, j=0; i<ColCount; i++){
                ...
                //Antes de adicionar aos dados visiveis � preciso verificar se a coluna � visivel
                if(j<VisibleTitle.size() && CompleteTitle.get(i).equalsIgnoreCase(VisibleTitle.get(j))){
                    VisibleLine.add(dat);
                    j++;
                }
    ...
    public void addOrSelectRow(java.sql.ResultSet Rs) throws java.sql.SQLException{
        ...
        if(Rs.next()){
            ...
            //Verificar se item j� n�o existe
            ...
            //Dado n�o existe na tabela, adicionar
            if(RowIndex<0){
                CompleteData.add(CompleteLine);
                VisibleData.add(VisibleLine);
                RowEditable.add(Boolean.TRUE);
    ...
    public void showColumn(int VisibleColIndex){
        ...
        if(VisibleColIndex>=0){
            //Verificar se o us�rio n�o est� tentando exibir uma coluna que j� est� visivel.
            ...
            //Refaz o modelo de exibi��o da tabela com os novos dados
            tmdModelo.setDataVector(VisibleData,VisibleTitle);
            setColumnSize();
        }
    }
    ...
    public void XprisTableMouseClicked(){
        ...
        if(this.getSelectedRowCount()==1){
            ...
            if(this.getRowSelectionAllowed() && this.getColumnSelectionAllowed()){
                //Sele��o de celula, comparar linha e coluna
    ...
    public class XprisDoubleCellEditor extends javax.swing.DefaultCellEditor {
        ...
        protected boolean userSaysRevert() {
            ...
            int answer = javax.swing.JOptionPane.showOptionDialog(
                    ...
                    "O valor deve ser um n�mero inteiro ou decimal separado por virgula.\n"
                    + "Voc� pode continuar editando ou retornar ao ultimo valor v�lido. ",
                    "Texto Inv�lido Digitado",
